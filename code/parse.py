...
#     print(f"Train file does not exist at path: {train_file}")
# if not os.path.exists(valid_file):
#     print(f"Valid file does not exist at path: {valid_file}")
# if not os.path.exists(test_file):
#     print(f"Test file does not exist at path: {test_file}")
# # 打印当前工作目录
